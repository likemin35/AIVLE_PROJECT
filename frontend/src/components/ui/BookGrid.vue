<template>
    <v-container>
        ...
        <div class="panel">
            ...
            <ViewBook @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></ViewBook>
                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="조회수">{{ val.viewCount }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Boolean label="베스트셀러여부" v-model="selectedRow.isBestSeller" :editMode="true"/>
                            <String label="작가명" v-model="selectedRow.authorName" :editMode="true"/>
                            <Number label="조회수" v-model="selectedRow.viewCount" :editMode="true"/>
